        ...
        try:
            ...
            if not error_message and valid_images:
                ...
                prompt_parts = [
                    ...
                    "**formatting rules**:",
                    "- Do NOT use numbered lists (1. 2. 3.). Use bullet points or icons.",
                    "- Do NOT use `##` for headers in your output. Use Bold like **Header**.",
                    "- Keep the response COMPACT. Do not add extra blank lines between items.",
                    "- For the medicine name, use an icon like 💊 instead of numbering.",
                    "### ⚠️ Drug Interactions",
