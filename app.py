        ...
        try:
            ...
            if not error_message and valid_images:
                ...
                prompt_parts = [
                    ...
                    "Rows MUST include:",
                    "- **Medicine Name**: Full name and generic details.",
                    "- **Usage**: Comprehensive explanation of what it treats and how it works.",
                    "- **Dosage**: Detailed dosage guidelines for adults and children (if applicable).",
                    "- **Side Effects**: various common and rare side effects.",
                    "Ensure the 'Details' column provides **in-depth information**, not just keywords.",
                    "Do NOT output a section header like '### Medicine Analysis'. Start directly with the table.",
                    "Do NOT use '##' headers inside the table.",
                    "",
                    "### ⚠️ Drug Interactions",
                    "**Critical**: If multiple different medicines are visible, check if they can be taken together. Explain any risks concisely.",
                    "",
                    "### 🛒 WHERE TO BUY",
                    "Provide a bulleted list of **search links** for major pharmacies.",
                    "Use these EXACT search URL patterns. Output them as a bulleted list of Markdown links:",
                    "- [Buy on 1mg](https://www.1mg.com/search/all?name=<Name>)",
                    "- [Buy on Apollo](https://www.apollopharmacy.in/search-medicines/<Name>)",
                    "- [Buy on Netmeds](https://www.netmeds.com/catalogsearch/result/<Name>)",
